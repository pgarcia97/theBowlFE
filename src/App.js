...
import './App.css';
import PsychBowlScreen from './PsychBowlScreen.js';
import BioBowlScreen from './BioBowlScreen.js';
import LexBowlScreen from './LexBowlScreen.js';
    ...
    let makeElementForScreen = (screenId, baseProps, atTop, forward) => {
      ...
      switch (screenId) {
        default:
          return null;
        case 'psychbowl':
          return (<PsychBowlScreen {...screenProps} />)
        case 'biobowl':
          return (<BioBowlScreen {...screenProps} />)
        case 'lexbowl':
          return (<LexBowlScreen {...screenProps} />)
        case 'start':
